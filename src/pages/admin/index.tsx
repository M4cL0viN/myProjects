            ...
            <form className="flex flex-col mt-3 mb-3 w-full max-w-xl " onSubmit={handleRegister}>
                ...
                {nameInput !== '' && (
                    <div className='flex items-center justify-center flex-col mb-7 p-1 border-gray-100/25 border rounded-md'>
                        ...
                        <article
                            className='w-11/12 max-w-lg flex flex-col items-center justify-between bg-zinc-900 rounded px1 py-3'
                ...
                <button type='submit' className=' mb-7 bg-blue-400 h-9 rounded-md cursor-pointer text-white font-medium gap-4 flex justify-center items-center'>
                    Cadastrar link
                </button>
